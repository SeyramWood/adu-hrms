...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])(["getStaffList", "getJobTitles", "getEmploymentStatus", "getDepartments"])),
  mounted: function mounted() {
    var _this = this;

    this.isLoading = true;
    this.$nextTick(function () {
      if (_this.getStaffList.data.length) {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapActions"])(["dispatchStaff"])), {}, {
    ...
    cancelAddJobTitle: function cancelAddJobTitle() {// console.log("cancel");
    },
                    ...
                    [
                      {
                        ...
                        fn: function() {
                          return [
                            _c("paginate", {
                              attrs: {
                                state: _vm.getStaffList,
                                dispatch: _vm.dispatchStaff
                              }
                            })
                          ]
                        },
                    ...
                    scopedSlots: _vm._u([
                      {
                        ...
                        fn: function(props) {
                          return [
                            _c("figure", { staticClass: "table-avatar" }, [
                              _c("img", {
