...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      ...
      this.usernameError = "";
      this.passwordError = "";
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_0__["Inertia"].post("/login", this.credentials, {
        errorBag: "userLogin",
        onError: function onError(err) {
          _this.usernameError = err.username ? err.username : "";
          _this.passwordError = err.username ? err.username : "";
          _this.credentialError = err.credentialError ? err.credentialError : "";
        }
      });
    }
  }
              ...
              _c(
                ...
                [
                  _c("div", { staticStyle: { width: "100%" } }, [
                    ...
                    _c(
                      "p",
                      { staticClass: "pt-2 login-forget-password" },
                      [
                        _c(
                          "inertia-link",
